        ...
        <header className='flex flex-col gap-5 md:gap-8'>
            <Link href='/' className='flex cursor-pointer items-center gap-1'>
                <Image 
                    ...
                    alt="NWB logo"
                />
                <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>NWB</h1>
            </Link>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className='flex gap-4'>
                                    <FormInput control={form.control} name='state' label='State' placeholder='Example: WI' />
                                    <FormInput control={form.control} name='postalCode' label='Postal Code' placeholder='Example: 54301' />
                                </div>
